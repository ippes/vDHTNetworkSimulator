...
/**
 * Simple putting strategy using version keys. Strategy fetches latest version,
 * updates it, generates a new version key according the fetched version and
 * puts it.
 * 
 * @author Seppi
 */
public final class TraditionalVersionPutStrategy extends PutStrategy {
	...
	private final Logger logger = LoggerFactory
			.getLogger(TraditionalVersionPutStrategy.class);
